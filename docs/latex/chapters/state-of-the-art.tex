...
While processing passenger numbers is usually a fairly conventional process (using spreadsheets, graphing the data, or utilising some form of machine learning), designing roads, transport lines and vehicles that fulfil the needs of a city usually requires specialist software; althought it is technically possible to use a generalist piece of software, such as Blender. 
