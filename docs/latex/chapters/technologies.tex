...
\section{OpenGL \raisebox{-1ex}{\hspace{1cm}\includegraphics[height=8mm, keepaspectratio]{images/opengl-logo.png}}}
...
\section{libGDX \raisebox{-0.1ex}{\hspace{1cm}\includegraphics[height=8mm, keepaspectratio]{images/libgdx_logo.png}}}
